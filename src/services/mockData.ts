...
export const INITIAL_PROFILES: UserProfile[] = [
  ...
  // Class 1 (5:30-6:30 PM) Students
  {
    ...
    role: 'student',
    gender: 'female',
    phone: '012309696 / 015254255',
    paymentDeadline: '1-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
  ...
  },
  {
    id: 'std-ciis-002',
    studentId: 'STD-002',
    fullName: 'ហ៊ិន ចិន្តា',
    username: 'hin.chinda',
    email: 'hin.chinda@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'female',
    phone: '0974411106 / 093595598',
    paymentDeadline: '3-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    ...
    studentId: 'STD-004',
    fullName: 'បល់ សុធីតា',
    username: 'bal.sothida',
    email: 'bal.sothida@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'female',
    phone: '0963336404 / 0973959862',
    paymentDeadline: '6-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    ...
    fullName: 'ធា ដាវ៉េន',
    username: 'thea.daven',
    email: 'thea.daven@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'female',
    phone: '078838593 / 0965180101',
    paymentDeadline: '7-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    ...
    role: 'student',
    gender: 'male',
    phone: '0968242314 / 0969239335',
    paymentDeadline: '8-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    ...
    role: 'student',
    gender: 'male',
    phone: '086232329 / 071202111',
    paymentDeadline: '12-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    ...
    fullName: 'សុំ សីហា',
    username: 'som.seyha',
    email: 'som.seyha@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'female',
    phone: '093576677 / 0967331974',
    paymentDeadline: '12-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
    classId: 'ciis-evening-1',
  ...
  },
  {
    ...
    role: 'student',
    gender: 'female',
    phone: '017495970 / 015411143',
    paymentDeadline: '16-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    id: 'std-ciis-010',
    studentId: 'STD-010',
    fullName: 'បូច ហ៊ុយឡាង',
    username: 'boch.huyloang',
    email: 'boch.huyloang@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'female',
    phone: '086 787 887',
    paymentDeadline: '20-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    ...
    fullName: 'លី រចនា',
    username: 'ly.rachana',
    email: 'ly.rachana@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'female',
    phone: '096 688 9900',
    paymentDeadline: '23-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'paid',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    ...
    studentId: 'STD-013',
    fullName: 'ជាក់ ស៊ីថៃ',
    username: 'cheak.sythai',
    email: 'cheak.sythai@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'male',
    phone: '015714364 / 081843807',
    paymentDeadline: '24-Aug-26',
    paymentAmount: 15,
  ...
  },
  {
    ...
    studentId: 'STD-014',
    fullName: 'លួង វឌ្ឍនៈ',
    username: 'loung.vathana',
    email: 'loung.vathana@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'male',
    phone: '017488084 / 077374762',
    paymentDeadline: '25-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'pending',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    id: 'std-ciis-015',
    studentId: 'STD-015',
    fullName: 'លី សុម៉ាធាទេ្វ',
    username: 'ly.somatheathevy',
    email: 'ly.somatheathevy@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'male',
    phone: '096 688 9900',
    paymentDeadline: '26-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'pending',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
  ...
  },
  {
    id: 'std-ciis-017',
    studentId: 'STD-017',
    fullName: 'ព្រៀន សុជាតាសារីត',
    username: 'prian.socheatasarith',
    email: 'prian.socheatasarith@ciis.edu',
    password: 'student123',
    role: 'student',
    gender: 'male',
    phone: '098567262 / 093567262',
    paymentDeadline: '28-Aug-26',
    paymentAmount: 15,
    paymentStatus: 'pending',
    classId: 'ciis-evening-1',
...
// -------------------------------------------------------------
// OFFICIAL JULY MONTHLY EXAMINATION RESULTS (from official paper)
// Shift Evening 5:30-6:30 | Class Teacher: NUN LANGDY | Director: ផល ស្រីណាខ
// -------------------------------------------------------------
export const INITIAL_MONTHLY_EXAMS: MonthlyExam[] = [
  {
    id: 'exam-july-2026-ciis-530',
    month: 'July 2026',
    monthKhmer: 'កក្កដា ២០២៦',
    title: 'Result for July',
    subject: 'Computer',
    shift: 'Shift Evening 5:30-6:30',
    classId: 'ciis-evening-1',
    className: 'CIIS Computer {5:30-6:30}',
    examDate: 'Friday, July 31, 2026',
    teacherName: 'NUN LANGDY',
    directorName: 'ផល ស្រីណាខ',
    quizQuestions: [
      {
        id: 'q-1',
        questionKhmer: 'តើ Shortcut មួយណាប្រើសម្រាប់ Save ឯកសារក្នុង Microsoft Word/Excel?',
        questionEnglish: 'Which shortcut is used to Save a document in Microsoft Word/Excel?',
        options: [
          { label: 'A', text: 'Ctrl + S' },
          { label: 'B', text: 'Ctrl + P' },
          { label: 'C', text: 'Ctrl + C' },
        ...
        correctAnswer: 'A',
        explanation: 'Ctrl + S is the universal standard shortcut to save active files.',
        points: 25
      },
      {
        id: 'q-2',
        questionKhmer: 'ក្នុង Microsoft Excel តើរូបមន្ត (Formula) ត្រូវចាប់ផ្តើមដោយសញ្ញាអ្វី?',
        questionEnglish: 'In Microsoft Excel, all formulas must begin with which character?',
        options: [
          { label: 'A', text: '+' },
          { label: 'B', text: '=' },
          { label: 'C', text: '#' },
        ...
        correctAnswer: 'B',
        explanation: 'All Excel formulas and functions must start with the equal sign (=).',
        points: 25
      },
      {
        id: 'q-3',
        questionKhmer: 'តើ Function មួយណាប្រើសម្រាប់គណនាផលបូកសរុបនៃ Cell ច្រើនក្នុង Excel?',
        questionEnglish: 'Which Excel function is used to calculate the sum of multiple cells?',
        options: [
          { label: 'A', text: '=AVERAGE()' },
          { label: 'B', text: '=SUM()' },
          { label: 'C', text: '=COUNT()' },
          { label: 'D', text: '=MAX()' }
        ],
        correctAnswer: 'B',
        explanation: '=SUM(range) calculates the total sum of all values in the selected range.',
        points: 25
      },
      {
        id: 'q-4',
        questionKhmer: 'តើការវាយអក្សរ Touch Typing លើក្តារចុចគួរដាក់ម្រាមដៃលើ Home Row Keys ណាខ្លះ?',
        questionEnglish: 'In Touch Typing, which keys form the standard Home Row position?',
        options: [
          { label: 'A', text: 'A S D F & J K L ;' },
          { label: 'B', text: 'Q W E R & U I O P' },
          { label: 'C', text: 'Z X C V & M , . /' },
          { label: 'D', text: '1 2 3 4 & 7 8 9 0' }
        ],
        correctAnswer: 'A',
        explanation: 'ASDF for the left hand and JKL; for the right hand form the core Home Row.',
        points: 25
      }
    ],
    records: [
      ...
      },
      {
        ...
        rank: 2,
        mention: 'C',
        other: 'Top 2 in July Exam (Fast Typist: 34 WPM)',
        isHonor: true
      },
      {
        id: 'rec-03',
        ...
        rank: 2,
        mention: 'C',
        other: 'Top 2 in July Exam (Highest Quiz: 94 pts)',
        isHonor: true
      },
      {
        id: 'rec-04',
        ...
        rank: 4,
        mention: 'D',
        other: 'Perfect Attendance (100%)'
      },
      {
        id: 'rec-05',
        no: 5,
        studentId: 'STD-016',
        studentName: 'ថុន យូលី',
        gender: 'female',
        attendance: 80,
        typing: 29,
        quiz: 62,
      ...
      },
      {
        ...
        rank: 10,
        mention: 'D',
        other: 'Strong Typing: 32 WPM'
      },
      {
        id: 'rec-11',
        no: 11,
        studentId: 'STD-003',
        studentName: 'ថេង សុខគីមហួរ',
        gender: 'male',
        attendance: 100,
        typing: 11,
        quiz: 30,
      ...
      },
      {
        ...
        rank: 16,
        mention: 'F',
        other: 'Absent on test day'
      },
      {
        id: 'rec-17',
        no: 17,
        studentId: 'STD-018',
        studentName: 'សុខ បញ្ញា',
        gender: 'male',
        attendance: 95,
        typing: 38,
        quiz: 88,
        ...
        rank: 1,
        mention: 'B',
        other: 'New Student Honor List (38 WPM)',
        isHonor: true
      },
      {
        id: 'rec-18',
        ...
        rank: 2,
        mention: 'B',
        other: 'New Student Honor List (35 WPM)',
        isHonor: true
      },
      {
        id: 'rec-19',
